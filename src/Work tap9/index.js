    ...
    return(
        <div class="container m-5">
            <div>
                ...
                <h6>Добавьте запоминающийся контент в свою галерею, чтобы <br /> выделиться среди конкурентов.</h6>
                <h2 class="mt-5">Фотографии ворка</h2>
                <h6>Загрузите фотографии, которые описывают или имеют отношение <br /> к вашему ворку. Только файлы с расширением png, jpg, jpeg.</h6>   
            </div>
            <div className="d-flex">
                <div class="Header-img m-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" viewBox="0 0 70 70" fill="none"><g clip-path="url(#clip0_421_465)"><path d="M0 35C0 54.299 15.701 70 35 70C54.299 70 70 54.299 70 35C70 15.701 54.299 0 35 0C15.701 0 0 15.701 0 35ZM17.5 35C17.5 34.0717 17.8687 33.1815 18.5251 32.5251C19.1815 31.8687 20.0717 31.5 21 31.5H31.5V21C31.5 20.0717 31.8687 19.1815 32.5251 18.5251C33.1815 17.8687 34.0717 17.5 35 17.5C35.9283 17.5 36.8185 17.8687 37.4749 18.5251C38.1312 19.1815 38.5 20.0717 38.5 21V31.5H49C49.9283 31.5 50.8185 31.8687 51.4749 32.5251C52.1312 33.1815 52.5 34.0717 52.5 35C52.5 35.9283 52.1312 36.8185 51.4749 37.4749C50.8185 38.1312 49.9283 38.5 49 38.5H38.5V49C38.5 49.9283 38.1312 50.8185 37.4749 51.4749C36.8185 52.1312 35.9283 52.5 35 52.5C34.0717 52.5 33.1815 52.1312 32.5251 51.4749C31.8687 50.8185 31.5 49.9283 31.5 49V38.5H21C20.0717 38.5 19.1815 38.1312 18.5251 37.4749C17.8687 36.8185 17.5 35.9283 17.5 35Z" fill="#FBA457"/></g><defs><clipPath id="clip0_421_465"><rect width="70" height="70" fill="white"/></clipPath></defs></svg>
                    <h6>Добавить фото </h6>
                </div>
                <div class="m-3">
                    <img src={Img} alt="" />
            ...
            <div class="mt-4">
                <h5>Документы ворка</h5>
                <h6 class="mt-3">Мы рекомендуем добавлять файл документа только в том случае, <br /> если он дополнительно разъясняет услугу, которую вы будете <br /> предоставлять.</h6>
            </div>
            ...
            <div>
                <p>Загружайте только файлы doc / pdf и не более 500 КБ</p>
            </div>
